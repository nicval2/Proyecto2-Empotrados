...
(
    ...
    localparam PAD4 = log2ceil(64'h3040 - 64'h3020); 
    localparam PAD5 = log2ceil(64'h3048 - 64'h3040); 
    localparam PAD6 = log2ceil(64'h3060 - 64'h3050); 
    localparam PAD7 = log2ceil(64'h3064 - 64'h3060); 
    localparam PAD8 = log2ceil(64'h3074 - 64'h3070); 
    localparam PAD9 = log2ceil(64'h30a0 - 64'h3080); 
    localparam PAD10 = log2ceil(64'h3120 - 64'h3100); 
    // -------------------------------------------------------
    ...
    // ( 0x3060 .. 0x3064 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 14'h3060  && write_transaction  ) begin
    ...
    // ( 0x3100 .. 0x3120 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 14'h3100   ) begin
