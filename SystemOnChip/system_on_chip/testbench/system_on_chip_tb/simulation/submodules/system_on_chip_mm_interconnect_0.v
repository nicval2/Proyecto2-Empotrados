...
module system_on_chip_mm_interconnect_0 (
	...
	wire         cmd_mux_004_src_valid;                                                      // cmd_mux_004:src_valid -> REG_BUTTON_s1_agent:cp_valid
	wire  [90:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> REG_BUTTON_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                      // REG_BUTTON_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> REG_BUTTON_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                              // cmd_mux_004:src_startofpacket -> REG_BUTTON_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                // cmd_mux_004:src_endofpacket -> REG_BUTTON_s1_agent:cp_endofpacket
	...
	wire         reg_button_s1_agent_rp_valid;                                               // REG_BUTTON_s1_agent:rp_valid -> router_006:sink_valid
	wire  [90:0] reg_button_s1_agent_rp_data;                                                // REG_BUTTON_s1_agent:rp_data -> router_006:sink_data
	wire         reg_button_s1_agent_rp_ready;                                               // router_006:sink_ready -> REG_BUTTON_s1_agent:rp_ready
	wire         reg_button_s1_agent_rp_startofpacket;                                       // REG_BUTTON_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         reg_button_s1_agent_rp_endofpacket;                                         // REG_BUTTON_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         reg_button_s1_agent_rdata_fifo_src_valid;                                   // REG_BUTTON_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] reg_button_s1_agent_rdata_fifo_src_data;                                    // REG_BUTTON_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         reg_button_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_004:in_0_ready -> REG_BUTTON_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                          // avalon_st_adapter_004:out_0_valid -> REG_BUTTON_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                           // avalon_st_adapter_004:out_0_data -> REG_BUTTON_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                          // REG_BUTTON_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                          // avalon_st_adapter_004:out_0_error -> REG_BUTTON_s1_agent:rdata_fifo_sink_error
