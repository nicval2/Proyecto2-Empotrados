add wave -noupdate -divider {system_on_chip_NIOS_cpu: top-level ports}
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: common}
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: breaks}
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: i_master}
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/i_read
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/i_waitrequest
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/i_address
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/i_readdata
add wave -noupdate -divider {system_on_chip_NIOS_cpu: npc_mux}
...
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/W_valid
add wave -noupdate -divider {system_on_chip_NIOS_cpu: interrupts}
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: rf}
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: alu}
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/clk
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: store}
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: load_data}
...
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/av_ld_data_aligned_unfiltered
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/av_ld_data_aligned_filtered
add wave -noupdate -divider {system_on_chip_NIOS_cpu: load_aligner}
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: d_master}
...
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/d_writedata
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/d_byteenable
add wave -noupdate -divider {system_on_chip_NIOS_cpu: shift_rotate}
...
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/E_shift_rot_result
add wave -noupdate -divider {system_on_chip_NIOS_cpu: control_registers}
...
add wave -noupdate -divider {system_on_chip_NIOS_cpu: system_on_chip_NIOS_cpu_nios2_oci_itrace}
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/cond_dct_taken
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/curr_pid
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/dct_buffer
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/dct_code
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/dct_count
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/dct_is_taken
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/exc_addr
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/instr_retired
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/advanced_exc_occured
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/is_cond_dct
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/is_dct
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/is_exception_no_break
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/is_fast_tlb_miss_exception
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/is_idct
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/is_uncond_dct
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/itm
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/not_in_debug_mode
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/pending_curr_pid
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/pending_exc_addr
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/pending_exc_handler
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/pending_exc_record_handler
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/pending_frametype
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/pending_prev_pid
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/prev_pid
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/prev_pid_valid
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/record_dct_outcome_in_sync
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/record_itrace
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/retired_pcb
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/snapped_curr_pid
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/snapped_pid
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/snapped_prev_pid
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/sync_code
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/sync_interval
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/sync_timer_reached_zero
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/sync_timer
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/sync_timer_next
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/trc_clear
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/trc_ctrl
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/trc_ctrl_reg
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/the_system_on_chip_NIOS_cpu_nios2_oci/the_system_on_chip_NIOS_cpu_nios2_oci_itrace/trc_on
