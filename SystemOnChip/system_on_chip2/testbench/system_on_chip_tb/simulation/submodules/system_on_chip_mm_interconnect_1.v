...
module system_on_chip_mm_interconnect_1 (
	...
	wire          rsp_mux_src_valid;                               // rsp_mux:src_valid -> ARM_h2f_axi_master_agent:write_rp_valid
	wire  [158:0] rsp_mux_src_data;                                // rsp_mux:src_data -> ARM_h2f_axi_master_agent:write_rp_data
	wire          rsp_mux_src_ready;                               // ARM_h2f_axi_master_agent:write_rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                             // rsp_mux:src_channel -> ARM_h2f_axi_master_agent:write_rp_channel
	wire          rsp_mux_src_startofpacket;                       // rsp_mux:src_startofpacket -> ARM_h2f_axi_master_agent:write_rp_startofpacket
	wire          rsp_mux_src_endofpacket;                         // rsp_mux:src_endofpacket -> ARM_h2f_axi_master_agent:write_rp_endofpacket
	wire          rsp_mux_001_src_valid;                           // rsp_mux_001:src_valid -> ARM_h2f_axi_master_agent:read_rp_valid
	wire  [158:0] rsp_mux_001_src_data;                            // rsp_mux_001:src_data -> ARM_h2f_axi_master_agent:read_rp_data
	wire          rsp_mux_001_src_ready;                           // ARM_h2f_axi_master_agent:read_rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                         // rsp_mux_001:src_channel -> ARM_h2f_axi_master_agent:read_rp_channel
	wire          rsp_mux_001_src_startofpacket;                   // rsp_mux_001:src_startofpacket -> ARM_h2f_axi_master_agent:read_rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                     // rsp_mux_001:src_endofpacket -> ARM_h2f_axi_master_agent:read_rp_endofpacket
